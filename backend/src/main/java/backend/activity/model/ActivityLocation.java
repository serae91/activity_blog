...
public class ActivityLocation {
    ...
    @Id
    @GeneratedValue(generator = "activity_location_sequence", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "activity_location_sequence", sequenceName = "activity_location_sequence", allocationSize = 1)
    @Column(name = "activity_location_id", nullable = false)
